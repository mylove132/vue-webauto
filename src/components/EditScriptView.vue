                ...
                if (response.code == 0) {
                    ...
                    if (script.protocolId == 1) {
                        ...
                        let $cookieHtml = '<div class="form-group cookieHead" style="clear: both">\n' +
                            '                                <div class="col-sm-2" style="float: left;margin-left: 150px">\n' +
                        ...
                        if (script.cookie != null) {
                            JSON.parse(script.cookie).forEach(function (cookie, index) {
                                ...
                                document.getElementsByClassName('removeButton')[index].onclick = function () {
                                    let delM = document.getElementsByClassName('cookieHead')[index]
                                    if (delM != null) {
                                        var result = delM.parentNode.removeChild(delM);
                                        if (result != null) {
                                            self.id -= 1
                                        }
                                    }
                        ...
                        if (script.header != null) {
                            JSON.parse(script.header).forEach(function (header, index) {
                                ...
                                document.getElementsByClassName('removeHeaderButton')[index].onclick = function () {
                                    let delK = document.getElementsByClassName('headers')[index];
                                    if (delK != null) {
                                        var result = delK.parentNode.removeChild(delK);
                                        if (result != null) {
                                            self.headerIndex -= 1
                                        }
                                    }
                        ...
                        if (script.params != null) {
                            if (script.params.toString().indexOf('paramskey') != -1) {
                                ...
                                JSON.parse(script.params).forEach(function (param, index) {
                                    ...
                                    self.paramsIndex++;
                                    document.getElementsByClassName('paramsKey')[index].value = param.paramskey;
                                    document.getElementsByClassName('paramsValue')[index].value = param.paramsvalue
                                    document.getElementsByClassName('removeParamsButton')[index].onclick = function () {
                                        let delK = document.getElementsByClassName('paramsHead')[index];
                                        if (delK != null) {
                                            var result = delK.parentNode.removeChild(delK);
                                            if (result != null) {
                                                self.paramsIndex -= 1
