                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        <a class="card-link" data-toggle="collapse" href="#collapse1"
                           style="color: white;font-size: 20px;display: block;float: left;margin-left: 200px;text-shadow:5px 2px 6px rgb(12,232,100);">
                            <label class="http"
                                   style="color: red;margin-left: -20px;margin-right: 20px;display: block;float: left">*</label>
                            HEADER设置
                        </a>
                        <a class="card-link" data-toggle="collapse" href="#collapse2"
                           style="margin-left:100px;color: white;font-size: 20px;display: block;float: left;text-shadow:5px 2px 6px rgb(12,232,100);">
                            <label class="http"
                                   style="color: red;margin-left: -20px;margin-right: 20px;display: block;float: left">*</label>
                            COOKIE设置
                        </a>
                        <a class="card-link" data-toggle="collapse" href="#collapse3"
                           style="margin-left: 100px;color: white;font-size: 20px;display: block;float: left;text-shadow:5px 2px 6px rgb(12,232,100);">
                            <label class="http dubbo websocket"
                                   style="color: red;margin-left: -20px;margin-right: 20px;display: block;float: left">*</label>
                            PARAM设置
                        </a>
                        <div class="row tm-content-row collapse hide" id="collapse1" data-parent="#accordion">
                            <div class="col-12 tm-block-col">
                                <div class="tm-bg-primary-dark tm-block tm-block-h-auto"
                                     style="height: 270px;overflow-y:auto;margin-left:-800px;margin-top: 80px">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary btn-block text-uppercase mb-3"
                                       onclick="addHeaderRow()">添加header</a>
                                </div>
                            </div>
                        </div>
                        <div class="row tm-content-row collapse hide" id="collapse2" data-parent="#accordion">
                            <div class="col-12 tm-block-col">
                                <div class="tm-bg-primary-dark tm-block tm-block-h-auto"
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary btn-block text-uppercase mb-3"
                                       onclick="addCookieRow()">添加cookie</a>
                                </div>
                            </div>
                        </div>
                        <div class="row tm-content-row collapse hide" id="collapse3" data-parent="#accordion">
                            <div class="col-12 tm-block-col">
                                <div class="tm-bg-primary-dark tm-block tm-block-h-auto"
                                     style="height: 270px;overflow-y:auto;margin-left:-800px;margin-top: 80px">
                                    <div class="row">
                                        <ul class="which_group" id="routeType"
                                            style="width: 99%;margin-left: 300px;margin-top: -20px">
                                            <li id="routeType_0" value="0" @click="checkrouteType(0)"
                                                style="color: white;width: 200px">&nbsp;form表单格式 &nbsp;
                                            </li>
                                            <li id="routeType_1" value="1" @click="checkrouteType(1)"
                                                style="color: white;width: 200px">&nbsp;json格式 &nbsp;
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="row" id="json_content" style="display: none;margin-top: 100px">
                                        <textarea
                                                style="width: 800px;height: 300px;background-color: #EEEEEE;border: 2px solid white;border-radius: 5px;color: #0c5460;margin-top: -80px"
                                                id="requestParam"></textarea>
                                    </div>
                                    <div class="row" id="form_content">
                                        <div class="col-12 tm-block-col" style="margin-left: 20px">
                                            <div class="tm-bg-primary-dark tm-block tm-block-h-auto"
                                                 style="height: 270px;overflow-y:auto;margin-left:0px;">
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-settings">
                        ...
                        <form action="" class="tm-signup-form row">
                            <div class="form-group col-lg-6">
                                <label class="http dubbo websocket"
                                       style="color: red;margin-left: 60px;margin-right: -50px;display: block;float: left">*</label><label
                                    for="interfaceName">接口名称</label>
                                <input
                                        id="interfaceName"
                                        name="interfaceName"
                                        type="text"
                            ...
                            <div class="form-group col-lg-6">
                                <label class="http websocket"
                                       style="color: red;margin-left: 60px;margin-right: -50px;display: block;float: left">*</label>
                            ...
                            <div class="form-group col-lg-6">
                                <label class="http websocket"
                                       style="color: red;margin-left: 60px;margin-right: -50px;display: block;float: left">*</label><label
                                    for="requestType">请求方式</label>
                                <select class="form-control" style="width:200px;text-align: center" id="requestType">
                                    <option v-for="requestType in requestTypeList" :value="requestType.id">
                                        {{requestType.name}}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-lg-6">
                                <label class="dubbo"
                                       style="color: red;margin-left: -20px;margin-left: 60px;margin-right: -50px;display: block;float: left">*</label>
                            ...
                            <div class="form-group col-lg-6">
                                <label class="dubbo"
                                       style="color: red;margin-left: -20px;margin-left: 60px;margin-right: -50px;display: block;float: left">*</label><label
                                    for="methodName">方法</label>
                                <input
                                        id="methodName"
                                        name="methodName"
                                        type="text"
                            ...
                            <div class="form-group col-lg-6">
                                <label class="dubbo"
                                       style="color: red;margin-left: -20px;margin-left: 60px;margin-right: -50px;display: block;float: left">*</label><label
                                    for="interfaceVersion">版本号</label>
                                <input
                                        id="interfaceVersion"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="writePlace"
                                 style="text-align: initial;padding:0px 25px;white-space: pre-line;word-wrap:break-word;"></div>
                        </div>
                    </div>
                </div>
            </div>
